...
function OrderModal({ item, gradient, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Print order:', { utility: name, ...order })
    setSubmitted(true)
  }
      ...
      >
        ...
        {submitted ? (
          <div className="flex flex-col items-center justify-center py-16 gap-4 px-8 text-center">
            ...
            <p className="text-indigo-600 font-bold text-lg">Total: ₹{total}</p>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl text-base font-semibold hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200"
            >
              Submit Order
            </button>
          </form>
